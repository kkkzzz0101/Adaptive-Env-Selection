...
class RayPPOTrainer(object):
    ...
    def _create_dataloader(self):
        ...
        if not self.config.trainer.sec.enable:
            ...
            priority_func = get_bandit_priority(dataset=self.train_dataset, **self.config.trainer.sec.bandit)
        else:
        ...
        self.train_dataloader = DataLoader(dataset=self.train_dataset,
                                           ...
                                           max_steps=self.config.trainer.total_training_steps) # if total_training_steps is not None, then we let the dataloader run forever and stop when the total_training_steps is reached instead of counting epochs
